...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InterventionMeasureDto', function() {
      beforeEach(function() {
        instance = new HmppsOffenderAssessmentApi.InterventionMeasureDto();
      });

      it('should create an instance of InterventionMeasureDto', function() {
        // TODO: update the code to test InterventionMeasureDto
        expect(instance).to.be.a(HmppsOffenderAssessmentApi.InterventionMeasureDto);
      });
