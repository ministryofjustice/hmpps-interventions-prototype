...
router.get("/cases", (req, res) => {
  const referrals = req.session.data.sprint6.referrals;
  ...
  res.render("sprint-6/monitor/cases", {
    referrals: req.session.data.sprint6.referrals,
...
router.get("/notifications", (req, res) => {
  const notifications = req.session.data.sprint6.notifications;
  ...
  res.render("sprint-6/monitor/notifications", {
...
router.get("/cases/:referralNumber/service-user", (req, res) => {
  ...
  res.render("sprint-6/monitor/cases/service-user", {
    referral: referral,
