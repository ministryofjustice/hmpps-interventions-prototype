...
router.use(function (req, res, next) {
    ...
    res.locals.serviceHref = "/sprint-6/book-and-manage/manage-a-referral/caseworker/dashboard";
    res.locals.loggedInUserName = req.session.data.sprint6.caseworkers[0].firstName;
...
function allReferrals(req) {
    referrals = []
    for (i = 0; i < req.session.data.sprint6.referrals.length; i++) {
...
function findReferralByIndex(req, index) {
    const referral = req.session.data.sprint6.referrals[index];
...
router.get("/referrals", (req, res) => {
    ...
    res.render("sprint-6/book-and-manage/manage-a-referral/caseworker/referrals", { referrals });
});
...
router.get("/referrals/:referralIndex/interventions/:interventionIndex/action-plan", (req, res) => {
    ...
    res.render("sprint-6/book-and-manage/manage-a-referral/caseworker/action-plan", { referral, intervention, referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, canChangeActionPlan, cssClassForSessionStatus });
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/action-plan-submission", (req, res) => {
    ...
    res.redirect(`/sprint-6/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/action-plan-confirmation`);
});
...
router.get("/referrals/:referralIndex/interventions/:interventionIndex/action-plan-confirmation", (req, res) => {
    ...
    res.render("sprint-6/book-and-manage/manage-a-referral/caseworker/action-plan-confirmation", { referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, intervention, referral });
});
...
router.get(`/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report`, (req, res) => {
    ...
    res.render(`sprint-6/book-and-manage/manage-a-referral/caseworker/end-of-service-report`, { intervention, referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, referral, isTermination });
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report-check-answers", (req, res) => {
    ...
    res.render("sprint-6/book-and-manage/manage-a-referral/caseworker/end-of-service-report-check-answers", { referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, intervention, referral, endOfServiceReport, isTermination });
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report-reason", (req, res) => {
	...
	case "delivered-successfully":
	    res.redirect(`/sprint-6/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report`);
	    break;
	case "termination":
	    res.redirect(`/sprint-6/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-contacted-probation-practitioner`);
	    break;
	default:
	    // Not building validation into the prototype, so just ask the
	    // question again.
	    res.redirect(`/sprint-6/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-reason`);
	    break;
    }
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report-contacted-probation-practitioner", (req, res) => {
	...
	case "yes":
	    res.redirect(`/sprint-6/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report?termination=true`);
	    break;
	case "no":
	    res.redirect(`/sprint-6/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-contact-probation-practitioner`);
	    break;
	default:
	    // Not building validation into the prototype, so just ask the
	    // question again.
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report", (req, res) => {
    ...
    res.redirect(`/sprint-6/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-confirmation`);
});
...
router.get("/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report-confirmation", (req, res) => {
    ...
    res.render("sprint-6/book-and-manage/manage-a-referral/caseworker/end-of-service-report-confirmation", { intervention, referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, referral });
});
...
router.get("/referrals/:referralIndex/interventions/:interventionIndex/initial-assessment", (req, res) => {
    ...
    res.render("sprint-6/book-and-manage/manage-a-referral/caseworker/initial-assessment", { intervention, referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, referral });
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/initial-assessment-delivered", (req, res) => {
    const intervention = findIntervention(req);
    ...
    if (req.body.delivered === "yes" || req.body.delivered.length === 1 && req.body.delivered[0] === "yes") {
...
for (const page of ["probation-practitioner-email-confirmation", "send-email", "upload-case-notes", "communication-archive", "casenotes-upload-confirmation", "end-of-service-report", "end-of-service-report-check-your-answers", "end-of-service-report-reason", "end-of-service-report-contacted-probation-practitioner", "end-of-service-report-contact-probation-practitioner"]) {
	...
	res.render(`sprint-6/book-and-manage/manage-a-referral/caseworker/${page}`, { intervention, referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, referral });
    });
}
