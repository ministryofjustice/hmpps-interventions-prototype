...
router.get("/find-multi-select", function (req, res) {
  const interventions = req.session.data.betaSprint2.findAnIntervention;
  ...
  res.render(
    "beta-sprint-2/book-and-manage/make-a-referral/find-an-intervention/find-multi-select",
    {
...
router.get("/results", function (req, res) {
  ...
  res.render(
    "beta-sprint-2/book-and-manage/make-a-referral/find-an-intervention/results",
    {
      selectedInterventions: selectedInterventions,
    }
  );
...
router.get("/:interventionId/details", function (req, res) {
  ...
  res.render(
    "beta-sprint-2/book-and-manage/make-a-referral/find-an-intervention/details",
    {
...
router.get("/confirm-selected-interventions", function (req, res) {
  ...
  res.render(
    "beta-sprint-2/book-and-manage/make-a-referral/find-an-intervention/confirm-selected-interventions",
    {
      selectedInterventions: selectedInterventions,
    }
  );
