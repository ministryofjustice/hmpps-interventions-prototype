...
router.use(function (req, res, next) {
  ...
  res.locals.serviceHref =
    "/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/dashboard";
  res.locals.loggedInUserName =
    req.session.data.betaSprint2.caseworkers[0].firstName;
  next();
});
...
function allReferrals(req) {
  referrals = [];
  for (i = 0; i < req.session.data.betaSprint2.referrals.length; i++) {
...
function findReferralByIndex(req, index) {
  const referral = req.session.data.betaSprint2.referrals[index];
...
router.get("/referrals", (req, res) => {
  ...
  res.render(
    "beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals",
    { referrals }
  );
});
...
router.get(
  ...
  (req, res) => {
    ...
    res.render(
      "beta-sprint-2/book-and-manage/manage-a-referral/caseworker/intervention",
      {
        referral,
        intervention,
...
router.get(
  ...
  (req, res) => {
    ...
    res.render(
      "beta-sprint-2/book-and-manage/manage-a-referral/caseworker/action-plan",
      {
        referral,
        intervention,
        referralIndex: req.params.referralIndex,
...
router.post(
  ...
  (req, res) => {
    ...
    res.redirect(
      `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/action-plan#activities-${req.params.desiredOutcomeIndex}`
    );
  }
);
...
router.post(
  ...
  (req, res) => {
    ...
    res.redirect(
      `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/action-plan#sessions`
    );
  }
);
...
router.post(
  ...
  (req, res) => {
    ...
    res.redirect(
      `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/action-plan-confirmation`
    );
  }
);
...
router.get(
  ...
  (req, res) => {
    ...
    res.render(
      "beta-sprint-2/book-and-manage/manage-a-referral/caseworker/action-plan-confirmation",
      {
        referralIndex: req.params.referralIndex,
        interventionIndex: req.params.interventionIndex,
        intervention,
...
router.get(
  ...
  (req, res) => {
    ...
    res.redirect(
      `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}`
    );
  }
);
...
router.get(
  ...
  (req, res) => {
    res.redirect(
      `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/sessions/${req.params.sessionIndex}/assessment/attended`
    );
  }
);
...
router.post(
  ...
  (req, res) => {
    ...
    res.redirect(
      `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/sessions/${req.params.sessionIndex}/assessment/${page}`
    );
  }
);
...
for (let i = 0; i < assessmentJourney.length; i++) {
  ...
  router.get(
    ...
    (req, res) => {
      ...
      res.render(
        `beta-sprint-2/book-and-manage/manage-a-referral/caseworker/assessment/${page}`,
        {
          referralIndex: req.params.referralIndex,
          interventionIndex: req.params.interventionIndex,
          intervention,
...
for (let i = 0; i < assessmentJourney.length - 1; i++) {
  ...
  router.post(
    ...
    (req, res) => {
      ...
      res.redirect(
        `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/sessions/${req.params.sessionIndex}/assessment/${nextPage}`
      );
    }
  );
}
...
router.get(
  ...
  (req, res) => {
    ...
    res.render(
      `beta-sprint-2/book-and-manage/manage-a-referral/caseworker/end-of-service-report`,
      {
        intervention,
        referralIndex: req.params.referralIndex,
        interventionIndex: req.params.interventionIndex,
...
router.post(
  ...
  (req, res) => {
    ...
    res.render(
      "beta-sprint-2/book-and-manage/manage-a-referral/caseworker/end-of-service-report-check-answers",
      {
        referralIndex: req.params.referralIndex,
        interventionIndex: req.params.interventionIndex,
        intervention,
  ...
  (req, res) => {
    switch (req.body.reason) {
      case "delivered-successfully":
        res.redirect(
          `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report`
        );
        break;
      case "termination":
        res.redirect(
          `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-contacted-probation-practitioner`
        );
        break;
      default:
        ...
        // question again.
        res.redirect(
          `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-reason`
        );
        break;
    }
  }
...
router.post(
  ...
  (req, res) => {
    switch (req.body["contacted-probation-practitioner"]) {
      case "yes":
        res.redirect(
          `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report?termination=true`
        );
        break;
      case "no":
        res.redirect(
          `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-contact-probation-practitioner`
        );
        break;
      default:
        // Not building validation into the prototype, so just ask the
...
router.post(
  ...
  (req, res) => {
    ...
    res.redirect(
      `/beta-sprint-2/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-confirmation`
    );
  }
);
...
router.get(
  ...
  (req, res) => {
    ...
    res.render(
      "beta-sprint-2/book-and-manage/manage-a-referral/caseworker/end-of-service-report-confirmation",
      {
        intervention,
        referralIndex: req.params.referralIndex,
        interventionIndex: req.params.interventionIndex,
...
router.get(
  ...
  (req, res) => {
    ...
    res.render(
      "beta-sprint-2/book-and-manage/manage-a-referral/caseworker/initial-assessment",
      {
        intervention,
        referralIndex: req.params.referralIndex,
        interventionIndex: req.params.interventionIndex,
...
for (const page of [
  ...
  router.get(
    ...
    (req, res) => {
      ...
      res.render(
        `beta-sprint-2/book-and-manage/manage-a-referral/caseworker/${page}`,
        {
          intervention,
          referralIndex: req.params.referralIndex,
          interventionIndex: req.params.interventionIndex,
