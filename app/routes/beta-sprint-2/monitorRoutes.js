...
router.get("/cases", (req, res) => {
  const referrals = req.session.data.betaSprint2.referrals;
  ...
  res.render("beta-sprint-1/monitor/cases", {
    referrals: req.session.data.betaSprint2.referrals,
    count: count,
...
router.get("/notifications", (req, res) => {
  const notifications = req.session.data.betaSprint2.notifications;
...
router.get("/cases/:referralNumber/service-user", (req, res) => {
  ...
  const referral = findReferral(
    req.session.data.betaSprint2.referrals,
    referralNumber
  );
