...
router.get("/referrals/:referralIndex", (req, res) => {
    ...
    res.render("sprint-3/book-and-manage/manage-a-referral/caseworker/referral", { referral, referralIndex: req.params.referralIndex, cssClassForInitialAssessmentStatus, cssClassForActionPlanStatus, someInitialAssessmentsScheduled });
});
...
router.get("/referrals/:referralIndex/interventions/:interventionIndex", (req, res) => {
    ...
    res.render("sprint-3/book-and-manage/manage-a-referral/caseworker/intervention", { intervention, referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, allSessionsCompleted, readyForEndOfServiceReport, canChangeActionPlan, moment, cssClassForSessionStatus, cssClassForActionPlanStatus });
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/goals", (req, res) => {
    ...
    res.redirect(`/sprint-3/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}`);
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/action-plan-submission", (req, res) => {
    ...
    res.redirect(`/sprint-3/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/action-plan-confirmation`);
});

router.get("/referrals/:referralIndex/interventions/:interventionIndex/action-plan-confirmation", (req, res) => {
    const intervention = findIntervention(req);

    res.render("sprint-3/book-and-manage/manage-a-referral/caseworker/action-plan-confirmation", { referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, intervention });
});
...
router.get("/referrals/:referralIndex/interventions/:interventionIndex/sessions/:sessionIndex/assessment", (req, res) => {
    ...
    res.render("sprint-3/book-and-manage/manage-a-referral/caseworker/assessment", { referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, intervention, sessionIndex });
});
...
router.get("/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report", (req, res) => {
    ...
    res.render("sprint-3/book-and-manage/manage-a-referral/caseworker/end-of-service-report", { referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex, intervention });
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report", (req, res) => {
    ...
    res.redirect(`/sprint-3/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}/interventions/${req.params.interventionIndex}/end-of-service-report-confirmation`);
});

router.get("/referrals/:referralIndex/interventions/:interventionIndex/end-of-service-report-confirmation", (req, res) => {
    const intervention = findIntervention(req);

    res.render("sprint-3/book-and-manage/manage-a-referral/caseworker/end-of-service-report-confirmation", { intervention, referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex });
});

router.get("/referrals/:referralIndex/interventions/:interventionIndex/initial-assessment", (req, res) => {
    const intervention = findIntervention(req);

    res.render("sprint-3/book-and-manage/manage-a-referral/caseworker/initial-assessment", { intervention, referralIndex: req.params.referralIndex, interventionIndex: req.params.interventionIndex });
});
...
router.post("/referrals/:referralIndex/interventions/:interventionIndex/initial-assessment", (req, res) => {
    ...
    res.redirect(`/sprint-3/book-and-manage/manage-a-referral/caseworker/referrals/${req.params.referralIndex}`);
});
